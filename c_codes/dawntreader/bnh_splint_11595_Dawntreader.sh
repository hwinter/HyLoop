...
#    User: winter@Dawntreader.local
#    IDL Version: 6.3 (darwin ppc)
#    Memory Bits: 32
#    File Bits: 64
#    Date: Fri Dec  8 18:00:03 2006
#
...
UNIQSTR="_11595_Dawntreader"
UNIQUE_NAME="bnh_splint_11595_Dawntreader"
REAL_NAME="bnh_splint"
SRC_DIR="/Users/winter/programs/PATC/c_codes/dawntreader"
RES_DIR="/Users/winter/programs/PATC/c_codes/dawntreader"
...
if [ $STATUS = 1 ]; then
  echo "% cc  -fPIC -no-cpp-precomp -dynamic -fPIC -fno-common -I\"/Applications/rsi/idl_6.3/external/include\" -c -D_REENTRANT \"$SRC_DIR/bnh_splint.c\" -o \"bnh_splint$UNIQSTR.o\"" > "$OUT_FILE_TMP"
 
  cc  -fPIC -no-cpp-precomp -dynamic -fPIC -fno-common -I"/Applications/rsi/idl_6.3/external/include" -c -D_REENTRANT "$SRC_DIR/bnh_splint.c" -o "bnh_splint$UNIQSTR.o" >> "$OUT_FILE_TMP" 2>&1
...
if [ $STATUS = 1 ]; then
  echo "% cc -bundle -flat_namespace -undefined suppress -o \"$RES_FILE_TMP\" \"bnh_splint$UNIQSTR.o\" " >> "$OUT_FILE_TMP"
 
  cc -bundle -flat_namespace -undefined suppress -o "$RES_FILE_TMP" "bnh_splint$UNIQSTR.o"  >> "$OUT_FILE_TMP" 2>&1
fi
