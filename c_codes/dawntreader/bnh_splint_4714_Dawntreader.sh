...
#    IDL Version: 6.2 (darwin ppc)
#    Memory Bits: 32
#    File Bits: 32
#    Date: Tue Jun 13 10:03:11 2006
#
...
UNIQSTR="_4714_Dawntreader"
UNIQUE_NAME="bnh_splint_4714_Dawntreader"
...
if [ $STATUS = 1 ]; then
  echo "% cc  -fPIC -no-cpp-precomp -dynamic -fPIC -fno-common -I\"/Applications/rsi/idl_6.2/external/include\" -c -D_REENTRANT \"$SRC_DIR/bnh_splint.c\" -o \"bnh_splint$UNIQSTR.o\"" > "$OUT_FILE_TMP"
 
  cc  -fPIC -no-cpp-precomp -dynamic -fPIC -fno-common -I"/Applications/rsi/idl_6.2/external/include" -c -D_REENTRANT "$SRC_DIR/bnh_splint.c" -o "bnh_splint$UNIQSTR.o" >> "$OUT_FILE_TMP" 2>&1
