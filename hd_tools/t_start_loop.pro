PRO t_start_loop,loop_file, lhist, g,A,x, E_h, L, T_max, orig, n_depth, note,$
	q0=q0, power=power, nosave=nosave,$
	outname=outname, newfile=newfile
;
...
restore,loop_file;,'../dana/xbp1_1020.sav'
;AXIS            FLOAT     = Array[3, 200]	;Mega Meter = 1e8 cm
;B               FLOAT     = Array[200]		;Gauss
;RAD             FLOAT     = Array[200]		;crossect radius Mega
;L               FLOAT     = Array[1, 200]	;Mega Meters
