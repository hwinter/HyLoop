...
function msu_kappa, T, SHOWME=SHOWME,SO=SO,SPIT=SPIT
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Tmin = 10^min(!msul_kappa_logT)
Tmax = 10^max(!msul_kappa_logT)
logtemp = alog10(T >Tmin <Tmax)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;DISP option
if keyword_set(SHOWME) then begin
	plot, !msul_kappa_logT,$
              2.5*!msul_kappa_logT+!msul_kappa_logc-6, psym=-1,$
              xtitle = '!6log T', $
	...
	oplot, !msul_kappa_logT, 2.5*!msul_kappa_logT-6,$
...
;new, zippy way
;n_tabulated = n_elements(!msul_kappa_logT)
;
...
;   
;endif else correction = 10^interpolate(!msul_kappa_logc, findex(!msul_kappa_logT, logtemp))

;correction = 10^interpolate(!msul_kappa_logc, findex(!msul_kappa_logT, logtemp))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
correction = 10^interpol(!msul_kappa_logc, !msul_kappa_logT,$
                         logtemp, /SPLINE)
