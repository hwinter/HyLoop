...
;-
pro loopeqt2, g, A, x, computer=computer,$
              heat=heat, Ttop=Ttop, fname=fname, LENGTH=LENGTH, $
              rebin=rebin, rtime=rtime, depth=depth, $
              safety=safety, T0=T0,STATE=STATE, $
              STATE_OUT=STATE_OUT,LOUD=LOUD, $
              DELTA_T=DELTA_T
               ;LABEL=LABEL
...
help, state
loopmodelt2, g, A, x, heat, rtime, state=state, T0=1e4, $
            outfile=fname, /src, /fal, /uri,$
            depth=depth, safety=safety,$
            so=so,LOUD=LOUD, DELTA_T=DELTA_T
