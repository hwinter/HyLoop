...
eps_name='energy_test_07_20.eps'
...
;  The NRL plasma formulary
        ...
        c=2*!dpi*(!msul_qe^4)*ln_lambda[0]
        
;Analytic delta_e
        anal_de1=de_dt[0]*delta_time;*keV_2_ergs
        anal_de=delta_time*$
                (((-C*2d0*loop.state.n_e[0]*energy2vel(nt_old.ke_total)) $
                  /(nt_old.ke_total*!msul_keV_2_ergs))/!msul_keV_2_ergs)
        print, 'anal_de= ',anal_de
        print, 'delta_e1',delta_e1
        etest_temp=100.*avg((anal_de-delta_e1)/anal_de)
...
;plot,BEAM_STRUCT.time, etest, psym=5,XTITLE='Time'
    ...
    e_array=e_array[1:n_elements(de2)-2]
    pmm, etest
...
hdw_pretty_plot2, xy0, xy1, xy2, xy3, $
                  ...
                  XTITLE='N Timesteps',YTITLE='% Diff. Analytic to Numeric',$
