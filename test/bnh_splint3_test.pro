...
InputFiles=['bnh_splint3']
OutputFile='bnh_splint3'
ExportedRoutineNames='bnh_splint3';['bnh_splint3','which_index'];'bnh_splint3';
...
MAKE_DLL, InputFiles , OutputFile, $
          ...
          /REUSE_EXISTING, /SHOW_ALL_OUTPUT, /VERBOSE
...
argc=5l
 ...
 foo = call_external(patc_dir+OutputFile+'.so', $ ; The SO
