; .r pa_alpha=-4_699_25_00001.pro
 
RUN_FOLDERS='../'
  
restore_file='test_loop_time.loop'
...
;Begin regrid keywords
    ...
    print, 'This run took '+string(run_time)+' to complete.'
profiler, /report
profiler, /report, FILENAME=folder+'profile_report_user_pp_'+strcompress(string(i), /remove)+'.txt'
profiler, /report, output=profile_user
save, profile_user, run_time, file=folder+'profile_report_user_pp_'+strcompress(string(i), /remove)+'.sav'
profiler, /reset
