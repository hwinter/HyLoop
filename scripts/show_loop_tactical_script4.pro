...
Data_dir=getenv('DATA')+'PATC/runs/piet_scaling_laws/Const_flux/alpha=0.0_beta=0.0/n_depth=50_n_cells=500/'
movie_name=Data_dir+'tac_movie.gif'
folder_1=Data_dir+;'alpha=-100/699_25/run_01/'
movie_folder=getenv('DATA')+'/PATC/movies/flare_tact/'
