...
file1=strcompress(patc_dir+'/runs/2005_11_03',/REMOVE_ALL)
file2=strcompress(run_folder+'loop_hist.sav',/REMOVE_ALL)
;restore,file1
restore,file2
loop_old=loop
...
colorbar, title='Low    Density (10e4)     High',divisions=2,$
