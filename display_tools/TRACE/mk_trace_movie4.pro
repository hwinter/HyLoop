...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    ;image_171=image_171*pixel*pixel
   ; image_171=tvrd()
    if size(array_171, /TYPE) eq 0 then Begin
        array_171=image_171 
        n_old_171_x=n_elements(array_171[*,0,0])
        n_old_171_y=n_elements(array_171[0,*,0])
       ; IF not keyword_set(XSIZE) THEN XSIZE=n_old_171_x
       ; IF not keyword_set(YSIZE) THEN YSIZE=n_old_171_y
    ...
    show_loop_image,axis,rad,$
                    ...
                    /NOSCALE; , xs=XSIZE, ys=ySIZE ;,/sqrt;
   ; image_195=image_195*pixel*pixel
