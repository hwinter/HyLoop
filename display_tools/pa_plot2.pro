...
pro pa_plot2, nt_beam, GIF_NAME=GIF_NAME,$
...
;        YRANGE=YRANGE, YSTYLE=YSTYLE,$
;        font=0;, _EXTRA=EXTRA
HISTOPLOT2, Double(pas), pa_array,n_array, BINSIZE=double(step),$
           AXISCOLORname="BLACK",BACKCOLORNAME="WHITE",$
           DATACOLORNAME='red', font=0,$
           CHARSIZE=charsize,CHARTHICK=charthick, $
           XTITLE=XTITLE_IN,YTITLE=YTITLE_IN,$
           TITLE=TITLE_IN, /FILLPOLYGON, POLYCOLOR="RED", $
           MININPUT=XRANGE[0], MAXINPUT=XRANGE[1], _extra=extra
