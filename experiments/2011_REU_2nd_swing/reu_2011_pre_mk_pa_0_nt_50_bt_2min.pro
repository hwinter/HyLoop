...
pro  reu_2011_pre_mk_pa_0_nt_50_bt_2min

  set_shrec_sys_variables

  index=ulong(getenv('TASKNUM'))

  RUN_FOLDERS ='run_'+$
               string(index,format='(I4.4)')+$
               '/' 
  folder=getenv('DATA')+'/HyLoop/runs/2011_REU_2nd_swing/pa_0_nt_50_bt_2min/'
...
;Thermal heating width sigma [cm]
defsysv,'!SIGMA',1d8
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
     ...
     HEAT_FUNCTION='pt_with_patc_gaussian_apex_heating'
