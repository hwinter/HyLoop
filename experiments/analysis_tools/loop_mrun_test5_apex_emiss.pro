...
;
pro   loop_mrun_test5_apex_emiss, map_1_name,map_2_name ,$
...
if size(PLOT_PREFIX, /TYPE) ne 7 then $
  PREFIX='mrun_test5_apex_emiss_' else  PREFIX=PLOT_PREFIX
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    for ll=0ul, n_files-1ul do begin
        junk=bootstrap_median(reform(Apex_emission[ll,*,0]))
        emiss_one_error[LL]=(junk[1]/junk[0])*100.
        junk=bootstrap_median(reform(Apex_emission[ll,*,1]))
