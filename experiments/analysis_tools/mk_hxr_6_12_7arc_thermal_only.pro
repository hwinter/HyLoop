;.r mk_hxr_6_12_7arc_thermal_only.pro


pro mk_hxr_6_12_7arc_thermal_only, $
...
print, 'Running mk_hxr_6_12_7arc_thermal_only'
  
if size(BREMS_MAP_ID, /TYPE) ne 7 then $
brems_map_id='HXR 6-12 (TO) kev'

if size(MAP_NAME, /TYPE) ne 7 then $
  map_name='6_12kev_7arc_thermal_only.map'
