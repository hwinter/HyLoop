...
pro  mk_xr_movie_02a_t_binned_static, $
...
prefix='image_2a_binned'
TITLE=['3-6 keV', $
       '3-6 keV NT ',$
       '3-6 keV Therm ' $
      ]
if not keyword_set(movie_name) then movie_name='avg_3_6_2a_binned'
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;Define coordinates
YC=0.0
XC=940.
...
for i=0ul,  n_folders-1ul do begin
  ...
  ;  !p.multi=[0,2,2]
             ...
             restore, MAP1_NAME
             ;fp_map=time_bin_map(map,n_elements(map)-1ul)
            fp_map=map;[0]
            fp_map.data=0
