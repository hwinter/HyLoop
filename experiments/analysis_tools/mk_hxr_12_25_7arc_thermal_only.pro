;.r mk_hxr_12_25_7arc_thermal_only.pro


pro mk_hxr_12_25_7arc_thermal_only, $
  EXPERIMENT_DIR=EXPERIMENT_DIR, $
  ALPHA_FOLDERS=ALPHA_FOLDERS, $
  GRID_FOLDERS=GRID_FOLDERS, $
  RUN_FOLDERS=RUN_FOLDERS, $
  BREMS_MAP_ID=BREMS_MAP_ID, $
  MAP_NAME=MAP_NAME

print, 'Running mk_hxr_12_25_7arc_thermal_only'
  
if size(BREMS_MAP_ID, /TYPE) ne 7 then $
brems_map_id='HXR 12-25 (TO) kev'

;;if size(MAP_NAME, /TYPE) ne 7 then $
  map_name='12_25kev_7arc_thermal_only.map'
