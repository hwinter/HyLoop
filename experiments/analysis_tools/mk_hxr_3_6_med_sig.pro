...
pro mk_hxr_3_6_med_sig, folders,$
                    EXT=EXT,$
                    SAVE_NAME=SAVE_NAME,$
...
IF NOT keyword_set(SAVE_NAME) THEN SAVE_NAME='hxr_3_6_med_emiss.save'
...
;             loop= interpolate_loop(loop, loops[0])
    ...
    emiss_array[*,i] =get_med_xr_emiss(loops, nt_brems_array,$
                            STD_DEV=STD_DEV, $
