;.r mk_xr_movie_06.pro

;A program to make a series of images and a movie simulating 
; XRT emission

;This requires that a series of averaged maps have been previously made
;This differs from mk_xr_movie_05 in that 06 makes apex to total
;emission ratios.
pro  mk_xr_movie_06, $
...
;Plot windows
MAP1_NAME='ti_poly_avg3.map'
MAP2_NAME='be_thin_avg3.map'
MAP3_NAME='be_med_avg3.map';'al_med_avg.map'

MAP1_dev_NAME='ti_poly_avg3_SDEV.map'
MAP2_dev_NAME='be_thin_avg3_SDEV.map'
MAP3_dev_NAME='be_med_avg3_SDEV.map';'al_med_avg.map'
;MAP1_NAME=MAP2_NAME
n_images=75
prefix='image_5'
TITLE=['Ti-Poly', $
...
if not keyword_set(movie_name) then movie_name='avg_xrt_06'
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;Define coordinates
YC=0.0
XC=940.
...
;error map
             ...
             temp_map.xc=XC
             temp_map.yc=YC
             sub_map,temp_map,a_dev_map1,xrange=apex_xr,yrange=apex_yr 
             fp_dev_map1=map
            ; sub_map, temp_map, fp_dev_map1, xrange=fp_xr,yrange=fp_yr
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
             restore, MAP2_name
             MAP2=map
             MAP2.xc=XC
...
;error map
             ...
             temp_map.xc=XC
             temp_map.yc=YC
             sub_map,temp_map,a_dev_map2,xrange=apex_xr,yrange=apex_yr 
             fp_dev_map2=map
             ;sub_map, temp_map, fp_dev_map2, xrange=fp_xr,yrange=fp_yr
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
             restore, MAP3_NAME
             MAP3=map
...
;error map
             ...
             temp_map.xc=XC
             temp_map.yc=YC
             sub_map,temp_map,a_dev_map3,xrange=apex_xr,yrange=apex_yr 
             fp_dev_map3=map
             ;sub_map, temp_map, fp_dev_map3, xrange=fp_xr,yrange=fp_yr
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
             ...
             scl_2=scl_1
             scl_3=scl_1
             a_signal_dev_1=a_signal_1
             a_signal_dev_2=a_signal_1
             a_signal_dev_3=a_signal_1
             fp_signal_dev_1=a_signal_1
             fp_signal_dev_2=a_signal_1
             fp_signal_dev_3=a_signal_1
...
;Error Maps
                 a_signal_dev_1[l] =sqrt(total((a_dev_map1[l].data*a_dev_map1[l].data)))
                 a_signal_dev_2[l] =sqrt(total((a_dev_map2[l].data*a_dev_map2[l].data)))
                 a_signal_dev_3[l] =sqrt(total((a_dev_map3[l].data*a_dev_map3[l].data)))
                 fp_signal_dev_1[l]=sqrt(total((fp_dev_map1[l].data*fp_dev_map1[l].data)))
                 fp_signal_dev_2[l]=sqrt(total((fp_dev_map2[l].data*fp_dev_map2[l].data)))
                 fp_signal_dev_3[l]=sqrt(total((fp_dev_map3[l].data*fp_dev_map3[l].data)))
...
variables_only:
         save,  a_signal_1,a_signal_2,a_signal_3,$
                ...
                scl_1,scl_2,scl_3, $
                a_signal_dev_1,a_signal_dev_2,$
                a_signal_dev_3,$
                fp_signal_dev_1,fp_signal_dev_2, $
                fp_signal_dev_3, $
                times,$
                file=Current_folder+'sig_vars_w_dev_06.sav'
         print, 'Variables saved to: '+Current_folder+'sig_vars_w_dev_06.sav'
      endfor;k loop
     endfor;j loop
 endfor; i loop
