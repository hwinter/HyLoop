;
;This procedure produces a single plot that charts the 
;time evolution of the apex emission in the two folders set

; apex_emiss_compare.pro
;
pro  apex_emiss_compare, map_name ,$
  TITLE=TITLE,$
...
if size(PLOT_PREFIX, /TYPE) ne 7 then $
  PREFIX='apex_emiss_compare_' else  PREFIX=PLOT_PREFIX
