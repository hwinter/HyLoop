;.r mk_hxr_12_25_7arc_nt_only.pro


pro mk_hxr_12_25_7arc_nt_only, $
...
print, 'Running mk_hxr_12_25_7arc_nt_only'
  
if size(MAP_ID, /TYPE) ne 7 then $
map_id='HXR 12-25 (NTO) kev'

if size(MAP_NAME, /TYPE) ne 7 then $
  map_name='12_25kev_7arc_nt_only.map'
