;.r mk_hxr_3_6_7arc_nt_only.pro


pro mk_hxr_3_6_7arc_thermal_only, $
...
print, 'Running mk_hxr_3_6_7arc_thermal_only'
  
if size(MAP_ID, /TYPE) ne 7 then $
map_id='HXR 3-6 (TO) kev'

if size(MAP_NAME, /TYPE) ne 7 then $
  map_name='3_6kev_7arc_thermal_only.map'
