...
Current_folder=EXPERIMENT_DIR[0]+'/'+ $
               ALPHA_FOLDERS[j]+'/'+ $
               GRID_FOLDERS[0]+'/'
restore, Current_folder+'sig_vars_w_dev_06.sav'
...
;Make a plot.
set_plot, 'ps'
      device, /portrait, file= 'a_total_ratio_w_error2.eps',$
              /CMYK, color=16, /enc
...
YRange=[.9*min([ratio_1_am4[1:n_images]-error_1_am4[1:n_images],$
                 ratio_1_a0[1:n_images]-error_1_a0[1:n_images],$
                 ratio_1_a4[1:n_images]-error_1_a4[1:n_images]]), $
        1.0*max([ratio_1_am4[1:n_images]+error_1_am4[1:n_images],$
                 ratio_1_a0[1:n_images]+error_1_a0[1:n_images],$
                 ratio_1_a4[1:n_images]+error_1_a4[1:n_images]]) ] ;,$
...
plot, times,ratio_1_am4[0:n_images] , /nodata, $
      ...
      XRANGE=[0, 425],YRANGE=YRANGE,/ystyle,$
...
YRange=[.9*min([ratio_2_am4[1:n_images]-error_2_am4[1:n_images],$
                 ratio_2_a0[1:n_images]-error_2_a0[1:n_images],$
                 ratio_2_a4[1:n_images]-error_2_a4[1:n_images]]), $
        1.0*max([ratio_2_am4[1:n_images]+error_2_am4[1:n_images],$
                 ratio_2_a0[1:n_images]+error_2_a0[1:n_images],$
                 ratio_2_a4[1:n_images]+error_2_a4[1:n_images]]) ]
...
;Error plot
errplot, times[index1],$
         (ratio_2_am4[index1]-error_2_am4[index1]),$;<= 0,$
...
;Error plot
errplot, times[index2],$
         (ratio_2_a0[index2]-error_2_a0[index2]),$;<=0,$
...
;Error plot
errplot, times[index3],$
         (ratio_2_a4[index3]-error_2_a4[index3]),$;<=0,$
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;           
tvlct, [0,255,0,0], [0,0,255,0], [0,0,0,255]
YRange=[.9*min([ratio_3_am4[1:n_images]-error_3_am4[1:n_images],$
                 ratio_3_a0[1:n_images]-error_3_a0[1:n_images],$
                 ratio_3_a4[1:n_images]-error_3_a4[1:n_images]]), $
        1.0*max([ratio_3_am4[1:n_images]+error_3_am4[1:n_images],$
                 ratio_3_a0[1:n_images]+error_3_a0[1:n_images],$
                 ratio_3_a4[1:n_images]+error_3_a4[1:n_images]]) ]
...
;Error plot
errplot, times[index1],$
         (ratio_3_am4[index1]-error_3_am4[index1]),$;>=0,$
         (ratio_3_am4[index1]+error_3_am4[index1]),$;<max(yrange),$
         color=1
...
oplot, times, $
       ...
       color=2, thick=4, line=0
;Error plot
;lower=ratio_3_a0[index2]-error_3_a0[index2]
;lower >=0
errplot, times[index2],$
         (ratio_3_a0[index2]-error_3_a0[index2]),$
         (ratio_3_a0[index2]+error_3_a0[index2]) ,$;<max(yrange), $
         color=2
...
;Error plot
errplot, times[index3],$
         (ratio_3_a4[index3]-error_3_a4[index3]),$;>=0,$
         (ratio_3_a4[index3]+error_3_a4[index3]),$; <max(yrange),  $
         color=3
