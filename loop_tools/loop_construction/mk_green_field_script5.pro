...
chart=1.7
bungey_cells=1d3
n_cells=450l                    ;Number of initial volumes
n_depth=25l                     ;Number of initial surfaces in the Chromosphere
...
contour,f2,y,z,nlevels=n_levels,$
        ...
        chars=chars, chart=chart, yrange=[-2, 0], ys=1
;overplot the current sheet
oplot,[0.,0.],[1,-1],thick=3,color=3
n_levels1=n_levels
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
old_device=!d.name
set_plot, 'ps'
device, FILE='green_current_sheet.ps', COLOR=8,$
        /LANDSCAPE

contour,f2,y,z,nlevels=n_levels,$
        TITLE="Field Lines for Green's Current Sheet Solution",$
        levels=levels,/ISOTROPIC,color=fgc,background=bgc,$
        chars=chars, chart=chart, font=0, yrange=[-2, 0], ys=1
;overplot the current sheet
oplot,[0.,0.],[1,-1],thick=5,color=3
for i =0, n_elements(path_xy2[0,*])-1l do begin
;wait,0.01 
    plots, path_xy2[*,$
                    path_info2[line_index].offset: $
                    line_end], color=1,thick=5;, $
          ; /DATA                ;,chars=chars, chart=chart
;oplot, path_xy2[*,$
;                path_info2[line_index].offset: $
;                line_end],color=135,thick=3
