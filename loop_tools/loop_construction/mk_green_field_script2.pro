...
n_s=n_cells-1l                  ;Number of initial surfaces
n_depth=20l                     ;Number of initial surfaces in the Chromosphere
;computer='dawntreader'
;computer='mithra'
max_time=2d0*60d0*60d0          ;Time to allow loop to come to equilibrium
rtime=5d0                      ;Output timestep
DELTA_T=1d                     ;reporting  timestep
...
Print, 'Chromospheric depth is: '+string(depth)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;Now all important quantities are defined.  now make a 
...
;a[*]=area_0
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
lhist={e:double(e), n_e:double(n_e), $
...
;    loopmodelt, g, A, s, q0, rtime, T0=1e4, $
;                 /fal, /uri,lhist=lhist,$
;                 safety=5,$;safety,$
;                 so=so,/src,   depth=depth,$
;                 OUTFILE='foo.sav', DELTA_T=DELTA_T
    ...
    temp_loop.state=lhist[n_elements(lhist)-1l]
    temp_loop.time=lhist[n_elements(lhist)-1l].time
    loop=temp_loop
