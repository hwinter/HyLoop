...
mk_dir,save_dir 
strand_files=file_search(data_dir+'/AIA/aia_strands/strand_start*',/FULLY_QUALIFY_PATH)
...
for i=0,N_strands-1l do begin
    ...
    outname1=save_dir+filename+'_base_initial_'+ext
    outname2=save_dir+filename+'_base_heated_'+ext
