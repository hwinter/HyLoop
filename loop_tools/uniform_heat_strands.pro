...
;uniform_heat_strands.pro
set_plot,'z'
computer='mithra'
patc_dir=getenv('PATC')
data_dir=getenv('DATA')
save_dir=data_dir+'/AIA/uniform_strands/'
mk_dir,save_dir 
...
for i=0,N_strands-1l do begin
    ...
    outname1=save_dir+filename+'_initial2_'+ext
    outname2=save_dir+filename+'_heated2_'+ext

    print,'outname1: '+save_dir+filename+'_initial2_'+ext
    print,'outname2: '+save_dir+filename+'_heated2_'+ext
