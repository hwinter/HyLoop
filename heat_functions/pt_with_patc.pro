...
function pt_with_patc, LOOP, time, dt, nt_beam, nt_brems,$
...
;First beam case.
       !beam_index eq 0 : begin
           ...
           extra_flux=loop.l*!injected_beam[0].thermal_e $
       ...
       !beam_index le n_elements(!injected_beam)-1 : begin
           ...
           extra_flux=loop.l*!injected_beam[!beam_index].thermal_e $
                      /(total(volumes)*!patc_dt)
           end
...
if time gt max(!injected_beam.time) then extra_Flux=0d0
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;End PaTC Section
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;Scaling factor
H=(Extra_flux+!constant_heat_flux)/int_tabulated(loop.s_alt[1:n_cells-2],power_law,/DOUBLE)

heat=H*(power_law)
heat=heat+PATC_heating_rate
;stop
return, heat
END
